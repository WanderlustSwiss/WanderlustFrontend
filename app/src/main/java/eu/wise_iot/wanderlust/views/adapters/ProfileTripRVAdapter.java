...
public class ProfileTripRVAdapter extends RecyclerView.Adapter<ProfileTripRVAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public ViewHolder(View itemView) {
            super(itemView);
            title = (TextView) itemView.findViewById(R.id.ListTourTitle);
            description = (TextView) itemView.findViewById(R.id.ListTourDescription);
            tripImage = (ImageView) itemView.findViewById(R.id.ListTourImageView);
            editIcon = (ImageView) itemView.findViewById(R.id.ListTourEdit);
            deleteIcon = (ImageView) itemView.findViewById(R.id.ListTourDelete);
